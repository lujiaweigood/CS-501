...
public class C3E27Geometry
{
    public static void main(String[] args)
    {
        ...
        String intro = "Compute if a point is in right triangle (0,0), (200,0), (0,100)";
        String ask = "Enter 2 numbers for 1 numbers for a point’s x- and y-coordinates in a single line separated by spaces:";
